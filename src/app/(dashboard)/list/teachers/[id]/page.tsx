...
const Page = () => {
  return (
    <div className="flex-1 p-4 flex flex-col xl:flex-row lg:flex-row gap-4">
      {/* LEFT */}
      <div className="w-full xl:w-2/3 lg:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            {/* CARDS */}
            <div className="bg-white p-4 gap-4 rounded-md flex w-full md:w-[48%] lg:w-full xl:w-[45%] 2xl:w-[48%]">
              <Image
      ...
      {/* RIGHT */}
      <div className="w-full xl:w-1/3 lg:w-1/3 flex flex-col gap-4">
        {/* SHORTCUT COMPONENT */}
